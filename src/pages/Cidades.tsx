...
const cities = [
  {
    id: "cuiaba",
    name: "Cuiabá",
    description: "Capital do estado e portal do Pantanal. Centro histórico colonial, gastronomia típica e ponto de partida para aventuras.",
  ...
  },
  {
    ...
    description: "Famosa pela Cachoeira Véu de Noiva, Mirante e centro geodésico da América do Sul. Paraíso de trilhas e vistas.",
  ...
  },
  {
    id: "nobres",
    name: "Nobres",
    description: "Destino de flutuação em águas cristalinas. Rios transparentes como Salobra e Estivado encantam visitantes.",
  ...
  },
  {
    id: "alta-floresta",
    name: "Alta Floresta",
    description: "Capital brasileira do birdwatching. Portal da Amazônia com floresta densa e biodiversidade incomparável.",
  ...
  },
  {
    id: "pocone",
    name: "Poconé",
    description: "Início da Transpantaneira, estrada-parque com 147km e 122 pontes. Melhor local para ver onças e jacarés.",
  ...
  },
  {
    ...
    description: "Portal do Araguaia com águas termais naturais, Vale dos Sonhos e praias fluviais espetaculares.",
  ...
  },
  {
    id: "caceres",
    name: "Cáceres",
    description: "Capital nacional da pesca às margens do Rio Paraguai. Festival Internacional de Pesca e patrimônio histórico.",
  ...
  },
  {
    id: "sinop",
    name: "Sinop",
    description: "Polo econômico do norte mato-grossense com infraestrutura moderna e acesso à natureza preservada.",
